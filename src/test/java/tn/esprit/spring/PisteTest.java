...
class PisteTest {
    ...
    void testRetrieveAllPistes() {
        ...
        pisteSet.add(new Piste(3L,"Piste 1", Color.BLUE, 1000, 20, new HashSet<>()));
        pisteSet.add(new Piste(4L,"Piste 2", Color.RED, 1500, 25, new HashSet<>()));
    ...
    void testRetrievePiste() {
        Long numPiste = 1L;
        Piste piste = new Piste(5L,"Sample Piste", Color.BLUE, 1200, 18, new HashSet<>());
